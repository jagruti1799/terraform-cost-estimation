...
mvn -version
echo "clone github repo in machine"
git clone https://github.com/jagruti1799/Tomcat-jakartaee.git
cd Tomcat-jakartaee
ls
mvn clean
sudo cp /home/einfochips/tomcat10-jakartaee9/target/helloworld.war /opt/tomcat/webapps
